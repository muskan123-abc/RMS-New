...
const ShareView = ({ setPopupVisibility }) => {
  return (
    <>
      <div className="w-full  max-w-[852px]  rounded-[10px] flex flex-col items-center justify-center mx-auto bg-common-bg-image placeholder: bg-fixed bg-cover bg-black py-10 lg:py-32 px-8 md:px-12 relative z-[100]">
        <span className="absolute top-3 sm:top-5 end-3 sm:end-5 cursor-pointer " onClick={() => setPopupVisibility(false)}>
          <CrossIcon />
        </span>
