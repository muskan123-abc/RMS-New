  ...
  return (
    <>
      <div className=" px-10 py-[30px] bg-[#FFFFFF0A] backdrop-blur-[130px] w-full flex relative rounded-xl md:flex-row flex-col items-center gap-x-12 max-w-[1140px] mx-auto ">
        <div className=" rounded-[12px_0px_12px_0px] h-[14px] min-w-[280px] bg-gradient top-0 left-1/2 absolute -translate-x-[62%] after:absolute after:h-0 after:w-full after:bg-transparent after:-bottom-3 after:translate-x-1/4 after:border-b-4 after:border-dashed after:border-[#443925]"></div>{" "}
        <div className=" rounded-[0_12px_0_12px] h-[14px] min-w-[280px] bg-gradient bottom-0 right-0 absolute  after:absolute after:h-0 after:w-full after:bg-transparent after:-top-3 after:-translate-x-1/4 after:border-b-4 after:border-dashed after:border-[#443925]"></div>{" "}
