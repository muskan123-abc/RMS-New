...
const Hero = ({ showSidebar }) => {
  ...
  return (
    <>
      ...
      <section
        className={`overflow-hidden min-h-screen grow relative w-full bg-homepage-hero-bg bg-cover bg-no-repeat bg-center py-20 sm:py-[100px] md:py-0 flex items-center `}>
        {/* Bottom blur effect */}
          ...
          <div className="flex flex-col md:flex-row flex-wrap justify-between md:items-center lg:min-h-screen">
            <div className=" md:w-6/12 custom-2xl:w-5/12 custom-3xl:w-[52%] 2xl:w-[55%] min-[1920px]:w-6/12 pe-3 lg:pe-0">
              ...
              <div className="hidden md:block">
                <CustomInput
                  placeholder="Search"
                  customStyles="w-full max-w-[343px] pe-14"
                  customStylesInput="w-full"
                  isButtonVisible={true}
                />
              </div>
